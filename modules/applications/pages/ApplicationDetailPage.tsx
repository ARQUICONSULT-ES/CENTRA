          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-gray-400 dark:text-gray-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
                <div className="flex-1">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">ID de la aplicación</p>
                  <p className="text-sm text-gray-700 dark:text-gray-300 font-mono">{application.id}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-900 dark:text-white font-medium">{application.publisher}</p>
                </div>
              </div>
              ...
              {application.latestReleaseVersion && (
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Última versión (Release)</p>
                    <p className="text-sm text-gray-900 dark:text-white font-medium font-mono">{application.latestReleaseVersion}</p>
              ...
              {application.githubUrl && (
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-gray-400 dark:text-gray-400 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Repositorio GitHub</p>
                    <a
                      href={application.githubUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:underline font-mono flex items-center gap-1"
                    >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="p-5 space-y-4">
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Total instalaciones</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">{installations.length}</p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Entornos activos</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">
